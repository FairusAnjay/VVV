...
typemenu = 'document'
img = setting.img
baper = '♡ۣۜۜ፝͜͜͡͡✿➣フェアラス'
apiku = 'https://FairusAnjay.github.io/'
gc_wa_lu = 'https://chat.whatsapp.com/CONEEVXvT8JCn4ZqYJVims' //klo gk punya gc wa gk usah di ganti 👍
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const alphaNumber = [`6285649064565@s.whatsapp.net`, `6285649064565@s.whatsapp.net` , `6285649064565@s.whatsapp.net`]
		...
		const ratee = ["𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×"]
